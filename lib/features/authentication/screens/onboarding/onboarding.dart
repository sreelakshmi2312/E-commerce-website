            ...
            child: PageView(
              ...
              children: const [
                OnBoarding(
                  ...
                  title: TApptexts.onboardingtext1,
                  subtitle: TApptexts.onboardingsubtext1,
                ),
                OnBoarding(
                  image: TImageString.onboardingimage2,
                  title: TApptexts.onboardingtext2,
                  subtitle: TApptexts.onboardingsubtext2,
                ),
                OnBoarding(
                  image: TImageString.onboardingimage3,
                  title: TApptexts.onboardingtext3,
                  subtitle: TApptexts.onboardingsubtext3,
                ),
              ],
            ),
          ),
