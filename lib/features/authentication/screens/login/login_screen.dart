...
import 'package:ecommerceapp/utils/helpers/helper_functions.dart';import 'package:iconsax/iconsax.dart';
      ...
      child: Padding(
        ...
        child: Column(
         ...
         children: [
          Image(
            height: 150,
            image: AssetImage(darkmode?TImageString.darkapplogo:TImageString.lightapplogo,)),
              ...
              TextFormField(
                ...
                Expanded(
                  child: Row(
                    ...
                    TextButton(onPressed: (){}, child:const Text(TApptexts.forgetPassword))
                  ],),
                ),
                const SizedBox(height:TAppsizes.spacebtwitems),
                ElevatedButton(onPressed: (){}, child:const Text(TApptexts.signIn)),
                const SizedBox(height:TAppsizes.spacebtwitems),
                ElevatedButton(onPressed: (){}, child:const Text(TApptexts.createAccount)),
                ]
              )
            ]
          )
